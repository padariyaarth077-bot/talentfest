...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Telent Fest — India's Ultimate Telent Festival Platform" },
      ...
      { property: "og:title", content: "Telent Fest — India's Ultimate Telent Festival Platform" },
      ...
      { name: "twitter:title", content: "Telent Fest — India's Ultimate Telent Festival Platform" },
