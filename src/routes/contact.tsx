...
import { Mail, Phone, MapPin, MessageCircle, CheckCircle2, Loader2, AlertCircle } from "lucide-react";
...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Get in touch with the TelentFest team for registrations, events, or partnerships." },
    ],
  }),
  component: ContactPage,
});

const address = "Ward No. 1, Raiya Road, Opp. Alap Green City, Rameshvar Park, Indian Park, Rajkot, Gujarat 360005";
const phone = "+91 84019 60422";
const email = "telentfestseminar@gmail.com";
const whatsapp = "+91 84019 60422";
const mapsEmbed = "https://www.google.com/maps?q=Ward%20No.%201%2C%20Raiya%20Road%2C%20Opp.%20Alap%20Green%20City%2C%20Rameshvar%20Park%2C%20Indian%20Park%2C%20Rajkot%2C%20Gujarat%20360005&output=embed";
...
const contactCards = [
  ...
  { icon: Phone, label: "Phone", value: phone, href: `tel:${phone.replace(/[\s+]/g, "").replace(/^\+/, "+")}` },
              ...
              {submitted ? (
                <div className="flex flex-col items-center gap-4 py-12 text-center">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-1">Thank you for contacting us. We will get back to you shortly.</p>
                  </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4" noValidate>
                  ...
                  <Button type="submit" disabled={submitting} className="w-full border-0 gradient-primary text-primary-foreground">
