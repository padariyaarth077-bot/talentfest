...
export const translations = {
  en: {
    ...
    gallery: {
      ...
      connectDatabase: "Connect MySQL to load live event galleries.",
    ...
    entryPass: {
      ...
      setupText: "Before the entry pass system will work, run this SQL in your db SQL Editor:",
    },
    register: {
  ...
  hi: {
    ...
    gallery: {
      ...
      connectDatabase: "लाइव इवेंट गैलरी लोड करने के लिए MySQL कनेक्ट करें।",
    ...
    entryPass: {
      ...
      setupText: "एंट्री पास सिस्टम चलाने से पहले db SQL Editor में यह SQL चलाएँ:",
    },
    register: {
